...
const LOCALES = {
  en: {
    ...
    cmd_skills: 'List available Neo skills',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for Neo.',
    ...
    settings_label_default_panel: 'Default panel',
    settings_desc_default_panel: 'Panel opened on startup when no URL panel override is present.',
    ...
    chat_queued_toast: (text) => `Queued: "${text}"`,
    chat_session_reconnected_queued: 'Current session is still running. Reconnected and queued your message.',
    chat_uploading: 'Uploading…',
    chat_upload_error_prefix: 'Upload error: ',
    chat_nothing_to_send: 'Nothing to send',
    chat_error_generic: 'An error occurred. Check server logs.',
    chat_error_label: 'Error',
    chat_connection_lost: 'Connection lost',
    chat_warning_label: 'Warning',
    chat_reconnecting: 'Reconnecting…',
    chat_reconnected: 'Reconnected',
    chat_context_compressed: 'Context compressed',
    chat_out_of_credits: 'Out of credits',
    chat_rate_limit_reached: 'Rate limit reached',
    chat_no_response_received: 'No response received',
    chat_check_api_key_model: 'Check your API key and model selection.',
    clarify_unavailable_status: 'Clarify unavailable on current server build. Restart server.',
    clarify_unavailable_toast: 'Clarify endpoint unavailable. Please restart server.',
    terminal_library_failed: 'Terminal library failed to load. Check network access to cdn.jsdelivr.net.',
    ...
    onboarding_title: 'Welcome to Neo',
    onboarding_lead: 'A quick guided setup will verify Neo, save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open Neo',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify Neo and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum Neo provider config.',
    ...
    onboarding_notice_system_ready: 'Neo looks reachable from the Web UI.',
    onboarding_notice_system_unavailable: 'Neo is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: 'Neo',
    ...
    onboarding_notice_setup_already_ready: 'A working Neo provider setup is already detected. You can keep it or replace it here.',
    ...
    onboarding_workspace_help: 'Pick the model Neo should use for new chats after setup completes.',
    ...
    // ── Neo WebUI: Dashboard, Projects, Finances ───────────────────────────
    ...
    dashboard_shortcuts_title: 'Shortcuts',
    dashboard_shortcuts_desc: 'Quick access to main panels without leaving the chat.',
    kpi_active_projects: 'Active Projects',
    kpi_tasks_in_progress: 'Tasks in Progress',
    kpi_completed: 'Completed',
    kpi_agents_online: 'Agents Online',
    kpi_delta_this_month: (n) => `+${Number(n || 0)} this month`,
    kpi_delta_since_yesterday: (n) => `+${Number(n || 0)} since yesterday`,
    kpi_delta_this_week: (n) => `+${Number(n || 0)} this week`,
    kpi_all_operational: 'All operational',
    dashboard_quick_actions: 'Quick Actions',
    dashboard_action_placeholder: 'Action prepared in chat while the dedicated backend flow is pending.',
    action_new_project: 'New Project',
    action_new_document: 'New Document',
    action_new_component: 'New Component',
    action_open_terminal: 'Open Terminal',
    action_generate_report: 'Generate Report',
    action_deploy_project: 'Deploy Project',
    ...
    meetings_add_participant: 'Add Participant',
    meetings_participant_name: 'Name',
    meetings_participant_email: 'Email',
    meetings_participant_whatsapp: 'WhatsApp',
    meetings_participant_role: 'Role',
    meetings_role_host: 'Host',
    meetings_role_client: 'Client',
    meetings_role_team: 'Team',
    meetings_role_guest: 'Guest',
    meetings_participant_remove: 'Remove',
    meetings_form_title: 'Title',
    meetings_title_placeholder: 'E.g., Sprint Review, Briefing...',
    meetings_project_placeholder: 'E.g., obreiro, brabus, 300...',
    meetings_scheduled_at: 'Date and time',
    meetings_scheduled_at_placeholder: 'Select date and time',
    meetings_required_error: 'Title and project required.',
    meetings_table_title: 'Meetings',
    meetings_search_placeholder: 'Search by title or project...',
    meetings_filter_status: 'Status',
    meetings_filter_project: 'Project/Client',
    meetings_filter_period: 'Period',
    meetings_sort_by: 'Sort by',
    meetings_actions: 'Actions',
    meetings_copy_link: 'Copy link',
    meetings_open_room: 'Open room',
    meetings_no_results: 'No meetings found matching current filters.',
    meetings_page_size: 'Items per page',
    meetings_prev: 'Previous',
    meetings_next: 'Next',
    sidebar_status_online: 'ONLINE',
    sidebar_talk_now: 'Chat now',
    topbar_vps_status: 'VPS Status',
    topbar_terminal_ssh: 'Terminal SSH',
    topbar_search: 'Search',
    topbar_notifications: 'Notifications',
    topbar_help: 'Help',
    topbar_admin: 'Admin',
    dashboard_topbar_placeholder: 'This control is a visual placeholder for the next operational flow.',
    dashboard_search_hint: 'Type to search conversations by title or recent content.',
    dashboard_search_no_results: 'No conversations found.',
    ...
    neo_finance_placeholder: 'The finance visual shell ships in Sprint 4. This link already reserves the correct panel in the Neo shell.',
    ...
    greeting_summary: 'Here\'s a summary of what\'s happening with your projects.',
    hero_status_online: 'STATUS: OPERATIONAL',
    projects_title: 'Projects',
    projects_subtitle: 'Manage and track your project progress',
    projects_filters: 'Filters',
    projects_kanban: 'Kanban',
    projects_new: '+ New Project',
    projects_col_backlog: 'Backlog',
    projects_col_in_progress: 'In Progress',
    projects_col_in_review: 'In Review',
    projects_col_completed: 'Completed',
    projects_add_task: '+ Add task',
    projects_total: 'Total',
    projects_category_design: 'Design',
    projects_category_frontend: 'Frontend',
    projects_category_backend: 'Backend',
    projects_category_database: 'Database',
    projects_category_infra: 'Infra',
    projects_category_devops: 'DevOps',
    projects_category_docs: 'Docs',
    projects_category_qa: 'QA',
    projects_category_security: 'Security',
    projects_priority_low: 'Low',
    projects_priority_medium: 'Medium',
    projects_priority_high: 'High',
    projects_create_title: 'New Project',
    projects_create_name: 'Name',
    projects_create_category: 'Category',
    projects_create_priority: 'Priority',
    projects_create_description: 'Description',
    projects_create_submit: 'Create',
    projects_archive: 'Archive',
    projects_unarchive: 'Unarchive',
    projects_archived: 'Archived',
    projects_archive_project: 'Archive project',
    projects_unarchive_project: 'Unarchive project',
    projects_archive_project_confirm: 'Archive this project? It and its tasks leave the active counts.',
    projects_unarchive_project_confirm: 'Unarchive this project?',
    projects_show_archived: 'Show archived',
    projects_edit_title: 'Edit Project',
    projects_save: 'Save',
    projects_edit_project_hint: 'Edit project',
    projects_task_links: 'Links',
    projects_task_refs_sessions: 'Sessions',
    projects_task_refs_github: 'GitHub',
    projects_task_refs_obsidian: 'Obsidian',
    projects_task_refs_empty: 'No links registered.',
    projects_toast_project_saved: 'Project saved.',
    projects_toast_project_archived: 'Project archived.',
    projects_toast_project_unarchived: 'Project unarchived.',
    projects_toast_task_archived: 'Task archived.',
    projects_toast_task_unarchived: 'Task unarchived.',
    projects_link_session: 'Link session',
    projects_move_to: 'Move to',
    projects_list: 'List',
    projects_list_id: 'ID',
    projects_list_task: 'Task',
    projects_list_project: 'Project',
    projects_list_priority: 'Priority',
    projects_list_owner: 'Owner',
    projects_list_status: 'Status',
    projects_list_source: 'Source',
    projects_list_per_page: 'Per page',
    projects_list_pager_summary: '{from}–{to} of {total}',
    projects_list_pager_empty: 'No tasks.',
    projects_filter_search_placeholder: 'Search task by title, code or tag…',
    projects_filter_dim_status: 'Status',
    projects_filter_dim_projects: 'Projects',
    projects_filter_dim_priorities: 'Priorities',
    projects_filter_dim_sources: 'Sources',
    projects_filter_dim_owners: 'Owners',
    projects_filter_due_label: 'Due date',
    projects_filter_due_any: 'Any due date',
    projects_filter_due_overdue: 'Overdue',
    projects_filter_due_week: 'Next 7 days',
    projects_filter_due_none: 'No due date',
    projects_filters_clear_all: 'Clear all',
    projects_filters_apply: 'Apply filters',
    projects_create_color: 'Color',
    projects_create_domain: 'Domain',
    projects_create_default_source: 'Default external source (optional)',
    projects_filter_text_placeholder: 'Search task, project or ref…',
    projects_filter_all_projects: 'All projects',
    projects_filter_all_priorities: 'All priorities',
    projects_filter_all_sources: 'All sources',
    projects_filter_all_owners: 'All owners',
    projects_source_local: 'Local',
    projects_empty_title: 'No projects yet',
    projects_empty_sub: 'Create a project to start organizing tasks and tracking progress.',
    projects_task_create_title: 'New Task',
    projects_task_edit_title: 'Edit Task',
    projects_task_title: 'Title',
    projects_task_project: 'Project',
    projects_task_status: 'Status',
    projects_task_category: 'Category',
    projects_task_priority: 'Priority',
    projects_task_owner: 'Owner',
    projects_task_due: 'Due date',
    projects_task_progress: 'Progress (0-100)',
    projects_task_external_ref: 'External reference (optional)',
    projects_task_ref_type: 'Type',
    projects_task_ref_key: 'Key',
    projects_task_ref_url: 'URL',
    projects_task_ref_none: 'None',
    projects_task_save: 'Save',
    projects_task_description: 'Description',
    projects_unassigned: 'No project',
    projects_need_project_first: 'Create a project before adding tasks.',
    projects_error_load: 'Failed to load projects.',
    projects_error_save: 'Failed to save.',
    projects_error_name_required: 'Name is required.',
    projects_error_title_required: 'Title is required.',
    projects_error_project_required: 'Select a project.',
    projects_toast_project_created: 'Project created.',
    projects_toast_task_created: 'Task created.',
    projects_toast_task_saved: 'Task saved.',
    ...
    finance_subtitle: 'Personal and business financial control',
    finance_revenue: 'Revenue',
    finance_expenses: 'Expenses',
    finance_net_balance: 'Net Balance',
    finance_investments: 'Investments',
    ...
    finance_empty_state: 'Add your first transaction',
    finance_by_category: 'Expenses by Category',
    finance_period_month: 'Month',
    finance_period_quarter: 'Quarter',
    finance_period_year: 'Year',
    finance_create_title: 'New Transaction',
    finance_create_type_revenue: 'Revenue',
    finance_create_type_expense: 'Expense',
    finance_create_type_investment: 'Investment',
    finance_create_description: 'Description',
    finance_create_amount: 'Amount',
    finance_create_date: 'Date',
    finance_create_category: 'Category',
    finance_create_method: 'Payment method',
    finance_create_recurrence: 'Recurrence',
    finance_create_notes: 'Notes',
    finance_create_submit: 'Save',
    meetings_details: 'Details',
    meetings_detail_title: 'Meeting Details',
    meetings_post_desc: 'This meeting has ended. You can now generate a summary, save it to Obsidian, or create Jira tasks.',
    meetings_detail_hint: 'View details and actions for this meeting',
    meetings_created_at: 'Created at',
    meetings_started_at: 'Started at',
    meetings_finished_at: 'Finished at',
    meetings_no_participants: 'No participants added yet',
    meetings_planned_title: 'Planned Meeting',
    meetings_planned_desc: 'This meeting has not started yet. You can open the room to start it.',
    meetings_external_title: 'Meeting in progress',
    meetings_external_desc: 'The room has been generated. Use the buttons to join or end the meeting.',
    meetings_participant_name_required: 'Participant name is required.',
    meetings_popup_blocked: 'Popup blocker prevented opening the meeting window. Please allow popups for this site.',
  },
  ...
  ru: {
    ...
    cmd_skills: 'Показать доступные навыки Neo',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_label_default_panel: 'Панель по умолчанию',
    settings_desc_default_panel: 'Панель, открываемая при запуске, если URL не задаёт другую панель.',
    ...
    onboarding_lead: 'Краткая пошаговая настройка проверит Neo, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть Neo',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить Neo и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера Neo.',
    ...
    onboarding_notice_system_ready: 'Neo, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: 'Neo ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    onboarding_check_agent: 'Neo',
    ...
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера Neo. Вы можете оставить её или заменить здесь.',
    ...
    onboarding_workspace_help: 'Выберите модель, которую Neo должен использовать для новых чатов после завершения настройки.',
    ...
    action_new_meeting: 'Новая встреча',
    meetings_title: 'Встречи',
    meetings_subtitle: 'Создавайте и управляйте встречами проектов',
    meetings_new: 'Новая встреча',
    meetings_project: 'Проект / Клиент',
    meetings_objective: 'Цель',
    meetings_participants: 'Участники',
    meetings_generate_room: 'Создать комнату',
    meetings_open_tab: 'Открыть в новой вкладке',
    meetings_end: 'Завершить встречу',
    meetings_status_planned: 'Запланирована',
    meetings_status_active: 'В процессе',
    meetings_status_finished: 'Завершена',
    meetings_status_processed: 'Обработана',
    meetings_post_title: 'После встречи',
    meetings_post_summary: 'Создать резюме',
    meetings_post_obsidian: 'Сохранить в Obsidian',
    meetings_post_jira: 'Создать задачу Jira',
    meetings_empty: 'Встреч пока нет. Создайте первую!',
    meetings_obj_alinhamento: 'Согласование',
    meetings_obj_homologacao: 'Утверждение',
    meetings_obj_fechamento_sprint: 'Закрытие спринта',
    meetings_obj_briefing: 'Брифинг',
    meetings_obj_suporte: 'Поддержка',
    meetings_obj_outro: 'Другое',
    meetings_add_participant: 'Добавить участника',
    meetings_participant_name: 'Имя',
    meetings_participant_email: 'Email',
    meetings_participant_whatsapp: 'WhatsApp',
    meetings_participant_role: 'Роль',
    meetings_role_host: 'Ведущий',
    meetings_role_client: 'Клиент',
    meetings_role_team: 'Команда',
    meetings_role_guest: 'Гость',
    meetings_participant_remove: 'Удалить',
    meetings_copy_link: 'Копировать ссылку',
    meetings_no_results: 'Встреч, соответствующих текущим фильтрам, не найдено.',
    meetings_detail_title: 'Детали встречи',
    meetings_started_at: 'Начата',
    meetings_open_room: 'Открыть комнату',
    meetings_finished_at: 'Завершена',
    meetings_form_title: 'Название',
    meetings_search_placeholder: 'Поиск по названию или проекту...',
    meetings_external_desc: 'Комната сгенерирована. Используйте кнопки для входа или завершения встречи.',
    meetings_title_placeholder: 'Например, Sprint Review, Briefing...',
    meetings_next: 'Вперед',
    meetings_no_participants: 'Участники еще не добавлены',
    meetings_prev: 'Назад',
    meetings_filter_project: 'Проект/Клиент',
    meetings_scheduled_at: 'Дата и время',
    meetings_page_size: 'Элементов на странице',
    meetings_table_title: 'Встречи',
    meetings_created_at: 'Создана',
    meetings_filter_status: 'Статус',
    meetings_popup_blocked: 'Блокировщик всплывающих окон помешал открыть окно встречи. Пожалуйста, разрешите всплывающие окна для этого сайта.',
    meetings_post_desc: 'Эта встреча завершена. Вы можете создать резюме, сохранить его в Obsidian или создать задачи Jira.',
    meetings_detail_hint: 'Просмотр сведений и действий для этой встречи',
    meetings_scheduled_at_placeholder: 'Выберите дату и время',
    meetings_external_title: 'Встреча продолжается',
    meetings_planned_desc: 'Эта встреча еще не началась. Вы можете открыть комнату, чтобы начать ее.',
    meetings_filter_period: 'Период',
    meetings_sort_by: 'Сортировать по',
    meetings_participant_name_required: 'Имя участника обязательно.',
    meetings_details: 'Детали',
    meetings_planned_title: 'Запланированная встреча',
    meetings_project_placeholder: 'Например, obreiro, brabus, 300...',
    meetings_required_error: 'Укажите название и проект.',
    meetings_actions: 'Действия',
  },
  ...
  es: {
    ...
    cmd_skills: 'Listar las skills de Neo disponibles',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_default_panel: 'Panel predeterminado',
    settings_desc_default_panel: 'Panel abierto al iniciar cuando la URL no define otro panel.',
    ...
    onboarding_title: 'Bienvenido a Neo',
    onboarding_lead: 'Una guía rápida verificará Neo, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir Neo',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica Neo y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de Neo.',
    ...
    onboarding_notice_system_ready: 'Parece que Neo está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'Neo todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    onboarding_check_agent: 'Neo',
    ...
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de Neo. Puedes conservarla o reemplazarla aquí.',
    ...
    onboarding_workspace_help: 'Elige el modelo que Neo debe usar para nuevos chats cuando termine la configuración.',
    ...
    projects_toast_task_created: 'Task created.',
    projects_toast_task_saved: 'Task saved.',
    projects_view_summary: 'Resumen',
    projects_summary_info: 'Info del Proyecto',
    projects_summary_kpis: 'KPIs',
    projects_summary_links: 'Enlaces Externos',
    projects_summary_recent: 'Actividad Reciente',
    projects_summary_jira_issues: 'Issues Jira',
    projects_summary_completion: 'completado',
    projects_summary_no_project: 'Seleccione un proyecto para ver su resumen',
    projects_summary_no_tasks: 'Sin tareas aún',
    projects_summary_domain: 'Dominio',
    projects_summary_status: 'Estado',
    projects_summary_created: 'Creado',
    projects_summary_source: 'Fuente',
    jira_sync: 'Sincronizar',
    jira_syncing: 'Sincronizando…',
    jira_sync_success: 'Sincronización completa',
    jira_sync_error: 'Sincronización fallida',
    jira_last_sync: 'Última sincronización',
    jira_create_issue: 'Crear en Jira',
    jira_create_success: 'Issue creada',
    jira_chip: 'JIRA',
    jira_never_synced: 'Nunca sincronizado',
    tab_meetings: 'Reuniones',
    action_new_meeting: 'Nueva Reunión',
    meetings_title: 'Reuniones',
    meetings_subtitle: 'Crea y gestiona reuniones de proyectos',
    meetings_new: 'Nueva Reunión',
    meetings_project: 'Proyecto / Cliente',
    meetings_objective: 'Objetivo',
    meetings_participants: 'Participantes',
    meetings_generate_room: 'Generar Sala',
    meetings_open_tab: 'Abrir en nueva pestaña',
    meetings_end: 'Finalizar Reunión',
    meetings_status_planned: 'Planificada',
    meetings_status_active: 'En curso',
    meetings_status_finished: 'Finalizada',
    meetings_status_processed: 'Procesada',
    meetings_post_title: 'Post-Reunión',
    meetings_post_summary: 'Generar Resumen',
    meetings_post_obsidian: 'Guardar en Obsidian',
    meetings_post_jira: 'Crear Tarea Jira',
    meetings_empty: '¡Aún no hay reuniones. Crea la primera!',
    meetings_obj_alinhamento: 'Alineación',
    meetings_obj_homologacao: 'Homologación',
    meetings_obj_fechamento_sprint: 'Cierre de Sprint',
    meetings_obj_briefing: 'Briefing',
    meetings_obj_suporte: 'Soporte',
    meetings_obj_outro: 'Otro',
    meetings_add_participant: 'Agregar Participante',
    meetings_participant_name: 'Nombre',
    meetings_participant_email: 'Email',
    meetings_participant_whatsapp: 'WhatsApp',
    meetings_participant_role: 'Rol',
    meetings_role_host: 'Anfitrión',
    meetings_role_client: 'Cliente',
    meetings_role_team: 'Equipo',
    meetings_role_guest: 'Invitado',
    meetings_participant_remove: 'Eliminar',
    meetings_copy_link: 'Copiar enlace',
    meetings_no_results: 'No se encontraron reuniones que coincidan con los filtros actuales.',
    meetings_detail_title: 'Detalles de la Reunión',
    meetings_started_at: 'Iniciada el',
    meetings_open_room: 'Abrir sala',
    meetings_finished_at: 'Finalizada el',
    meetings_form_title: 'Título',
    meetings_search_placeholder: 'Buscar por título o proyecto...',
    meetings_external_desc: 'La sala ha sido generada. Use los botones para unirse o finalizar la reunión.',
    meetings_title_placeholder: 'Ej. Revisión de Sprint, Briefing...',
    meetings_next: 'Siguiente',
    meetings_no_participants: 'Aún no se han agregado participantes',
    meetings_prev: 'Anterior',
    meetings_filter_project: 'Proyecto/Cliente',
    meetings_scheduled_at: 'Fecha y hora',
    meetings_page_size: 'Elementos por página',
    meetings_table_title: 'Reuniones',
    meetings_created_at: 'Creada el',
    meetings_filter_status: 'Estado',
    meetings_popup_blocked: 'El bloqueador de ventanas emergentes impidió abrir la ventana de la reunión. Por favor, permita las ventanas emergentes para este sitio.',
    meetings_post_desc: 'Esta reunión ha terminado. Ahora puede generar un resumen, guardarlo en Obsidian o crear tareas de Jira.',
    meetings_detail_hint: 'Ver detalles y acciones para esta reunión',
    meetings_scheduled_at_placeholder: 'Seleccione fecha y hora',
    meetings_external_title: 'Reunión en curso',
    meetings_planned_desc: 'Esta reunión no ha comenzado. Puede abrir la sala para iniciarla.',
    meetings_filter_period: 'Período',
    meetings_sort_by: 'Ordenar por',
    meetings_participant_name_required: 'El nombre del participante es obligatorio.',
    meetings_details: 'Detalles',
    meetings_planned_title: 'Reunión Planificada',
    meetings_project_placeholder: 'Ej. obreiro, brabus, 300...',
    meetings_required_error: 'Se requiere título y proyecto.',
    meetings_actions: 'Acciones',
  },
  ...
  de: {
    ...
    cmd_skills: 'Verfügbare Neo-Skills auflisten',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_label_default_panel: 'Standard-Panel',
    settings_desc_default_panel: 'Panel, das beim Start geöffnet wird, wenn die URL kein anderes Panel vorgibt.',
    settings_label_theme: 'Theme',
    settings_label_skin: 'Skin',
    settings_label_font_size: 'Font size',
    font_size_small: 'Small',
    ...
    onboarding_title: 'Willkommen bei Neo',
    ...
    onboarding_step_system_desc: 'Neo muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie Neo.',
    ...
    meetings_participants: 'Placeholder',
    finance_budgets: 'Placeholder',
    chat_connection_lost: 'Placeholder',
    automation_development_sub: 'Placeholder',
    meetings_status_finished: 'Placeholder',
    projects_filter_all_owners: 'Placeholder',
    dashboard_notifications_unsupported: 'Placeholder',
    meetings_title: 'Placeholder',
    meetings_generate_room: 'Placeholder',
    meetings_copy_link: 'Link kopieren',
    projects_category_design: 'Placeholder',
    meetings_no_results: 'Keine Besprechungen gefunden, die den aktuellen Filtern entsprechen.',
    meetings_detail_title: 'Besprechungsdetails',
    chat_session_reconnected_queued: 'Placeholder',
    dashboard_notifications_disabled: 'Placeholder',
    dashboard_action_placeholder: 'Placeholder',
    meetings_open_tab: 'Placeholder',
    projects_task_progress: 'Placeholder',
    meetings_new: 'Placeholder',
    jira_sync_success: 'Placeholder',
    finance_create_description: 'Placeholder',
    projects_task_title: 'Placeholder',
    jira_never_synced: 'Placeholder',
    kpi_active_projects: 'Placeholder',
    sidebar_talk_now: 'Placeholder',
    finance_expenses: 'Placeholder',
    projects_toast_project_archived: 'Placeholder',
    meetings_started_at: 'Gestartet am',
    projects_col_backlog: 'Placeholder',
    meetings_open_room: 'Raum öffnen',
    chat_warning_label: 'Placeholder',
    greeting_good_afternoon: 'Placeholder',
    meetings_finished_at: 'Beendet am',
    meetings_form_title: 'Titel',
    meetings_end: 'Placeholder',
    projects_filters: 'Placeholder',
    projects_filter_dim_projects: 'Placeholder',
    projects_filter_all_priorities: 'Placeholder',
    projects_list_source: 'Placeholder',
    projects_summary_no_tasks: 'Placeholder',
    projects_empty_title: 'Placeholder',
    projects_filter_text_placeholder: 'Placeholder',
    projects_task_ref_none: 'Placeholder',
    projects_view_summary: 'Placeholder',
    projects_unassigned: 'Placeholder',
    meetings_post_obsidian: 'Placeholder',
    meetings_participant_role: 'Placeholder',
    projects_filter_all_projects: 'Placeholder',
    projects_task_refs_empty: 'Placeholder',
    projects_task_owner: 'Placeholder',
    chat_reconnected: 'Placeholder',
    finance_period_year: 'Placeholder',
    projects_list_priority: 'Placeholder',
    projects_create_submit: 'Placeholder',
    projects_create_name: 'Placeholder',
    finance_create_type_investment: 'Placeholder',
    dashboard_overview_title: 'Placeholder',
    meetings_search_placeholder: 'Suche nach Titel oder Projekt...',
    finance_empty_state: 'Placeholder',
    chat_queued_toast: 'Placeholder',
    projects_list_task: 'Placeholder',
    dashboard_search_no_results: 'Placeholder',
    meetings_add_participant: 'Placeholder',
    sidebar_status_online: 'Placeholder',
    meetings_external_desc: 'Der Raum wurde erstellt. Nutzen Sie die Schaltflächen, um teilzunehmen oder das Treffen zu beenden.',
    chat_nothing_to_send: 'Placeholder',
    projects_create_priority: 'Placeholder',
    projects_edit_project_hint: 'Placeholder',
    projects_task_due: 'Placeholder',
    projects_need_project_first: 'Placeholder',
    projects_summary_kpis: 'Placeholder',
    jira_syncing: 'Placeholder',
    finance_net_balance: 'Placeholder',
    meetings_title_placeholder: 'Z.B. Sprint Review, Briefing...',
    projects_list_pager_empty: 'Placeholder',
    projects_category_backend: 'Placeholder',
    action_deploy_project: 'Placeholder',
    finance_recent_transactions: 'Placeholder',
    meetings_next: 'Weiter',
    projects_create_domain: 'Placeholder',
    projects_category_infra: 'Placeholder',
    finance_create_category: 'Placeholder',
    projects_save: 'Placeholder',
    dashboard_shortcuts_desc: 'Placeholder',
    meetings_obj_suporte: 'Placeholder',
    meetings_status_processed: 'Placeholder',
    projects_filter_dim_priorities: 'Placeholder',
    projects_edit_title: 'Placeholder',
    dashboard_shortcuts_title: 'Placeholder',
    neo_projects_placeholder: 'Placeholder',
    projects_kanban: 'Placeholder',
    meetings_participant_remove: 'Placeholder',
    meetings_obj_homologacao: 'Placeholder',
    meetings_obj_fechamento_sprint: 'Placeholder',
    kpi_all_operational: 'Placeholder',
    automation_development_title: 'Placeholder',
    chat_no_response_received: 'Placeholder',
    projects_list_project: 'Placeholder',
    projects_task_external_ref: 'Placeholder',
    action_new_project: 'Placeholder',
    topbar_terminal_ssh: 'Placeholder',
    meetings_no_participants: 'Noch keine Teilnehmer hinzugefügt',
    dashboard_quick_actions: 'Placeholder',
    projects_archived: 'Placeholder',
    finance_by_category: 'Placeholder',
    meetings_obj_alinhamento: 'Placeholder',
    projects_link_session: 'Placeholder',
    finance_create_date: 'Placeholder',
    projects_create_description: 'Placeholder',
    neo_tasks_placeholder: 'Placeholder',
    projects_priority_medium: 'Placeholder',
    projects_category_docs: 'Placeholder',
    projects_summary_recent: 'Placeholder',
    projects_filter_due_none: 'Placeholder',
    projects_task_edit_title: 'Placeholder',
    finance_create_type_revenue: 'Placeholder',
    tab_projects: 'Placeholder',
    projects_task_ref_type: 'Placeholder',
    meetings_role_team: 'Placeholder',
    projects_task_status: 'Placeholder',
    clarify_unavailable_toast: 'Placeholder',
    meetings_prev: 'Zurück',
    finance_title: 'Placeholder',
    meetings_filter_project: 'Projekt/Kunde',
    projects_error_save: 'Placeholder',
    clarify_unavailable_status: 'Placeholder',
    kpi_delta_this_week: 'Placeholder',
    projects_filter_all_sources: 'Placeholder',
    meetings_participant_email: 'Placeholder',
    greeting_good_morning: 'Placeholder',
    finance_period_quarter: 'Placeholder',
    greeting_good_evening: 'Placeholder',
    projects_task_refs_sessions: 'Placeholder',
    projects_category_security: 'Placeholder',
    finance_create_submit: 'Placeholder',
    development_badge: 'Placeholder',
    projects_task_category: 'Placeholder',
    finance_create_recurrence: 'Placeholder',
    projects_list_owner: 'Placeholder',
    automation_development_note: 'Placeholder',
    meetings_objective: 'Placeholder',
    projects_category_database: 'Placeholder',
    kpi_tasks_in_progress: 'Placeholder',
    chat_reconnecting: 'Placeholder',
    meetings_role_host: 'Placeholder',
    projects_toast_task_unarchived: 'Placeholder',
    jira_create_success: 'Placeholder',
    meetings_obj_briefing: 'Placeholder',
    meetings_subtitle: 'Placeholder',
    topbar_vps_status: 'Placeholder',
    kpi_agents_online: 'Placeholder',
    dashboard_overview_desc: 'Placeholder',
    chat_context_compressed: 'Placeholder',
    projects_category_qa: 'Placeholder',
    projects_archive_project: 'Placeholder',
    dashboard_notifications_blocked: 'Placeholder',
    projects_archive: 'Placeholder',
    meetings_obj_outro: 'Placeholder',
    meetings_scheduled_at: 'Datum und Uhrzeit',
    chat_check_api_key_model: 'Placeholder',
    finance_create_title: 'Placeholder',
    finance_revenue: 'Placeholder',
    projects_task_create_title: 'Placeholder',
    meetings_page_size: 'Einträge pro Seite',
    projects_priority_high: 'Placeholder',
    meetings_table_title: 'Besprechungen',
    meetings_created_at: 'Erstellt am',
    projects_source_local: 'Placeholder',
    chat_error_label: 'Placeholder',
    meetings_status_planned: 'Placeholder',
    meetings_post_summary: 'Placeholder',
    neo_agents_empty_sub: 'Placeholder',
    projects_filters_apply: 'Placeholder',
    projects_filter_due_overdue: 'Placeholder',
    meetings_filter_status: 'Status',
    finance_new: 'Placeholder',
    projects_list_status: 'Placeholder',
    jira_sync_error: 'Placeholder',
    greeting_welcome_back: 'Placeholder',
    projects_create_color: 'Placeholder',
    kpi_completed: 'Placeholder',
    projects_list_id: 'Placeholder',
    topbar_help: 'Placeholder',
    neo_tasks_subtitle: 'Placeholder',
    projects_col_completed: 'Placeholder',
    sidebar_docs: 'Placeholder',
    projects_category_devops: 'Placeholder',
    projects_add_task: 'Placeholder',
    projects_filter_due_label: 'Placeholder',
    finance_create_type_expense: 'Placeholder',
    meetings_popup_blocked: 'Pop-up-Blocker hat das Öffnen des Besprechungsfensters verhindert. Bitte erlauben Sie Pop-ups für diese Website.',
    meetings_post_desc: 'Dieses Treffen ist beendet. Sie können nun eine Zusammenfassung erstellen, in Obsidian speichern oder Jira-Aufgaben erstellen.',
    projects_task_project: 'Placeholder',
    projects_priority_low: 'Placeholder',
    meetings_status_active: 'Placeholder',
    meetings_detail_hint: 'Details und Aktionen für dieses Treffen anzeigen',
    projects_filter_search_placeholder: 'Placeholder',
    topbar_admin: 'Placeholder',
    projects_summary_source: 'Placeholder',
    projects_list: 'Placeholder',
    neo_finance_placeholder: 'Placeholder',
    projects_error_load: 'Placeholder',
    action_new_document: 'Placeholder',
    projects_summary_no_project: 'Placeholder',
    projects_col_in_review: 'Placeholder',
    dashboard_search_hint: 'Placeholder',
    projects_create_title: 'Placeholder',
    projects_task_priority: 'Placeholder',
    projects_summary_jira_issues: 'Placeholder',
    projects_total: 'Placeholder',
    finance_goals: 'Placeholder',
    projects_filter_dim_status: 'Placeholder',
    hero_status_online: 'Placeholder',
    projects_empty_sub: 'Placeholder',
    projects_unarchive_project_confirm: 'Placeholder',
    chat_uploading: 'Placeholder',
    chat_upload_error_prefix: 'Placeholder',
    chat_rate_limit_reached: 'Placeholder',
    projects_summary_links: 'Placeholder',
    neo_agents_subtitle: 'Placeholder',
    jira_chip: 'Placeholder',
    kpi_delta_since_yesterday: 'Placeholder',
    action_open_terminal: 'Placeholder',
    finance_create_method: 'Placeholder',
    meetings_empty: 'Placeholder',
    finance_period_month: 'Placeholder',
    meetings_role_guest: 'Placeholder',
    projects_toast_task_saved: 'Placeholder',
    tab_finance: 'Placeholder',
    chat_out_of_credits: 'Placeholder',
    terminal_library_failed: 'Placeholder',
    projects_category_frontend: 'Placeholder',
    projects_task_ref_url: 'Placeholder',
    meetings_scheduled_at_placeholder: 'Datum und Uhrzeit auswählen',
    projects_subtitle: 'Placeholder',
    projects_title: 'Placeholder',
    meetings_project: 'Placeholder',
    back_to_dashboard: 'Placeholder',
    jira_last_sync: 'Placeholder',
    projects_filter_dim_sources: 'Placeholder',
    action_new_component: 'Placeholder',
    projects_task_save: 'Placeholder',
    meetings_external_title: 'Besprechung läuft',
    meetings_post_jira: 'Placeholder',
    dashboard_updated: 'Placeholder',
    chat_error_generic: 'Placeholder',
    finance_subtitle: 'Placeholder',
    projects_filter_due_any: 'Placeholder',
    action_generate_report: 'Placeholder',
    meetings_post_title: 'Placeholder',
    finance_investments: 'Placeholder',
    projects_toast_task_created: 'Placeholder',
    projects_archive_project_confirm: 'Placeholder',
    projects_filters_clear_all: 'Placeholder',
    projects_move_to: 'Placeholder',
    projects_error_name_required: 'Placeholder',
    projects_summary_status: 'Placeholder',
    projects_summary_created: 'Placeholder',
    projects_toast_project_unarchived: 'Placeholder',
    projects_task_refs_obsidian: 'Placeholder',
    projects_unarchive_project: 'Placeholder',
    projects_list_per_page: 'Placeholder',
    projects_summary_completion: 'Placeholder',
    projects_summary_domain: 'Placeholder',
    greeting_summary: 'Placeholder',
    tab_agents: 'Placeholder',
    projects_error_project_required: 'Placeholder',
    meetings_planned_desc: 'Dieses Treffen hat noch nicht begonnen. Sie können den Raum öffnen, um es zu starten.',
    jira_create_issue: 'Placeholder',
    tab_automation: 'Placeholder',
    dashboard_topbar_placeholder: 'Placeholder',
    meetings_filter_period: 'Zeitraum',
    meetings_sort_by: 'Sortieren nach',
    projects_task_refs_github: 'Placeholder',
    projects_task_ref_key: 'Placeholder',
    projects_unarchive: 'Placeholder',
    projects_filter_dim_owners: 'Placeholder',
    projects_toast_project_created: 'Placeholder',
    topbar_notifications: 'Placeholder',
    jira_sync: 'Placeholder',
    meetings_participant_name: 'Placeholder',
    dashboard_notifications_enabled: 'Placeholder',
    meetings_participant_name_required: 'Teilnehmername ist erforderlich.',
    projects_col_in_progress: 'Placeholder',
    meetings_details: 'Details',
    projects_error_title_required: 'Placeholder',
    meetings_planned_title: 'Geplante Besprechung',
    meetings_participant_whatsapp: 'Placeholder',
    meetings_project_placeholder: 'Z.B. obreiro, brabus, 300...',
    meetings_required_error: 'Titel und Projekt erforderlich.',
    neo_agents_empty: 'Placeholder',
    projects_filter_due_week: 'Placeholder',
    finance_create_amount: 'Placeholder',
    kpi_delta_this_month: 'Placeholder',
    sidebar_support: 'Placeholder',
    projects_create_category: 'Placeholder',
    meetings_actions: 'Aktionen',
    topbar_search: 'Placeholder',
    projects_task_description: 'Placeholder',
    projects_summary_info: 'Placeholder',
    projects_create_default_source: 'Placeholder',
    projects_toast_task_archived: 'Placeholder',
    meetings_role_client: 'Placeholder',
    projects_task_links: 'Placeholder',
    projects_toast_project_saved: 'Placeholder',
    projects_list_pager_summary: 'Placeholder',
    projects_new: 'Placeholder',
    projects_show_archived: 'Placeholder',
    action_new_meeting: 'Placeholder',
    tab_meetings: 'Placeholder',
    finance_create_notes: 'Placeholder',
  },
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_label_default_panel: '\u9ed8\u8ba4\u9762\u677f',
    settings_desc_default_panel: '\u5f53 URL \u672a\u6307\u5b9a\u5176\u4ed6\u9762\u677f\u65f6\uff0c\u542f\u52a8\u65f6\u6253\u5f00\u7684\u9762\u677f\u3002',
    ...
    onboarding_lead: '快速引导将验证 Neo、保存真实的提供商配置、选择工作区和模型，并可选设置密码保护应用。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '设置已跳过 — 使用现有配置。',
    onboarding_open: '打开 Neo',
    onboarding_step_system_title: '系统检查',
    onboarding_step_system_desc: '验证 Neo 与配置可见性。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存最小可用的 Neo 提供商配置。',
    ...
    onboarding_notice_system_ready: 'Neo 看起来可从 Web UI 访问。',
    onboarding_notice_system_unavailable: 'Neo 尚未完全可用。Bootstrap 可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: 'Neo',
    ...
    onboarding_notice_setup_already_ready: '已检测到可用的 Neo 提供商配置。你可以保留它，或在这里替换。',
    ...
    onboarding_workspace_help: '选择设置完成后 Neo 在新聊天中使用的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    kpi_delta_this_week: (n) => `+${Number(n || 0)} this week`,
    kpi_tasks_in_progress: 'Tasks in Progress',
    neo_agents_subtitle: '实时代理可视化',
    neo_agents_empty: '当前没有代理在工作',
    neo_agents_empty_sub: '当Neo启动会话时，代理将出现在这里。',
    neo_finance_placeholder: 'The finance visual shell ships in Sprint 4. This link already reserves the correct panel in the Neo shell.',
    neo_projects_placeholder: 'The 4-column Kanban ships in Sprint 3. This link already reserves the correct panel in the Neo shell.',
    neo_tasks_placeholder: 'The consolidated task view will connect to the upstream todos flow. Use Automation for cron jobs.',
    neo_tasks_subtitle: 'Operational task list',
    ...
    projects_toast_task_created: 'Task created.',
    projects_toast_task_saved: 'Task saved.',
    projects_view_summary: '摘要',
    projects_summary_info: '项目信息',
    projects_summary_kpis: 'KPIs',
    projects_summary_links: '外部链接',
    projects_summary_recent: '最近活动',
    projects_summary_jira_issues: 'Jira Issues',
    projects_summary_completion: '已完成',
    projects_summary_no_project: '选择一个项目查看摘要',
    projects_summary_no_tasks: '暂无任务',
    projects_summary_domain: '领域',
    projects_summary_status: '状态',
    projects_summary_created: '创建时间',
    projects_summary_source: '来源',
    jira_sync: '同步',
    jira_syncing: '同步中…',
    jira_sync_success: '同步完成',
    jira_sync_error: '同步失败',
    jira_last_sync: '上次同步',
    jira_create_issue: '在Jira中创建',
    jira_create_success: 'Issue已创建',
    jira_chip: 'JIRA',
    jira_never_synced: '从未同步',
    tab_meetings: '会议',
    action_new_meeting: '新建会议',
    meetings_title: '会议',
    meetings_subtitle: '创建和管理项目会议',
    meetings_new: '新建会议',
    meetings_project: '项目 / 客户',
    meetings_objective: '目标',
    meetings_participants: '参与者',
    meetings_generate_room: '创建房间',
    meetings_open_tab: '在新标签页中打开',
    meetings_end: '结束会议',
    meetings_status_planned: '已计划',
    meetings_status_active: '进行中',
    meetings_status_finished: '已结束',
    meetings_status_processed: '已处理',
    meetings_post_title: '会后',
    meetings_post_summary: '生成摘要',
    meetings_post_obsidian: '保存到 Obsidian',
    meetings_post_jira: '创建 Jira 任务',
    meetings_empty: '暂无会议。创建第一个吧！',
    meetings_obj_alinhamento: '对齐',
    meetings_obj_homologacao: '验收',
    meetings_obj_fechamento_sprint: '冲刺结束',
    meetings_obj_briefing: '简报',
    meetings_obj_suporte: '支持',
    meetings_obj_outro: '其他',
    meetings_add_participant: '添加参与者',
    meetings_participant_name: '姓名',
    meetings_participant_email: '邮箱',
    meetings_participant_whatsapp: 'WhatsApp',
    meetings_participant_role: '角色',
    meetings_role_host: '主持人',
    meetings_role_client: '客户',
    meetings_role_team: '团队',
    meetings_role_guest: '嘉宾',
    meetings_participant_remove: '移除',
    meetings_copy_link: '复制链接',
    meetings_no_results: '没有找到符合当前筛选条件的会议。',
    meetings_detail_title: '会议详情',
    meetings_started_at: '开始时间',
    meetings_open_room: '进入会议室',
    meetings_finished_at: '结束时间',
    meetings_form_title: '标题',
    meetings_search_placeholder: '按标题或项目搜索...',
    meetings_external_desc: '会议室已生成。使用按钮加入或结束会议。',
    meetings_title_placeholder: '例如：Sprint Review, Briefing...',
    meetings_next: '下一页',
    meetings_no_participants: '尚未添加参与者',
    meetings_prev: '上一页',
    meetings_filter_project: '项目/客户',
    meetings_scheduled_at: '日期和时间',
    meetings_page_size: '每页条数',
    meetings_table_title: '会议',
    meetings_created_at: '创建时间',
    meetings_filter_status: '状态',
    meetings_popup_blocked: '弹出窗口拦截程序阻止了打开会议窗口。请允许此网站的弹出窗口。',
    meetings_post_desc: '会议已结束。您现在可以生成总结、保存到 Obsidian 或创建 Jira 任务。',
    meetings_detail_hint: '查看此会议的详细信息和操作',
    meetings_scheduled_at_placeholder: '选择日期和时间',
    meetings_external_title: '会议进行中',
    meetings_planned_desc: '此会议尚未开始。您可以打开会议室以开始会议。',
    meetings_filter_period: '时间段',
    meetings_sort_by: '排序方式',
    meetings_participant_name_required: '参与者姓名是必填项。',
    meetings_details: '详情',
    meetings_planned_title: '已计划的会议',
    meetings_project_placeholder: '例如：obreiro, brabus, 300...',
    meetings_required_error: '标题和项目必填。',
    meetings_actions: '操作',
  },
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'Neo 的預設值與介面行為。',
    ...
    settings_label_default_panel: '\u9810\u8a2d\u9762\u677f',
    settings_desc_default_panel: '\u7576 URL \u672a\u6307\u5b9a\u5176\u4ed6\u9762\u677f\u6642\uff0c\u555f\u52d5\u6642\u958b\u555f\u7684\u9762\u677f\u3002',
    ...
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5 Neo\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 Neo \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: '\u5728\u6b64\u9078\u64c7\u5feb\u901f\u63d0\u4f9b\u8005\u8a2d\u5b9a\u8def\u5f91\u3002\u9032\u968e OAuth \u8a2d\u5b9a\u4ecd\u8acb\u4f7f\u7528 Hermes CLI\u3002',
    onboarding_notice_system_ready: 'Neo \u53ef\u5f9e Web UI \u5b58\u53d6\u3002',
    onboarding_notice_system_unavailable: 'Neo \u5c1a\u672a\u5b8c\u5168\u53ef\u7528\u3002\u5f15\u5c0e\u7a0b\u5f0f\u53ef\u80fd\u5b89\u88dd\u5b83\uff0c\u4f46\u63d0\u4f9b\u8005\u8a2d\u5b9a\u53ef\u80fd\u4ecd\u9700\u7d42\u7aef\u6a5f\u3002',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 Neo \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 Neo \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 Neo',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 Neo \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    meetings_title: 'Placeholder',
    meetings_generate_room: 'Placeholder',
    meetings_copy_link: '複製連結',
    projects_category_design: 'Placeholder',
    meetings_no_results: '沒有找到符合當前篩選條件的會議。',
    meetings_detail_title: '會議詳情',
    chat_session_reconnected_queued: 'Placeholder',
    dashboard_notifications_disabled: 'Placeholder',
    dashboard_action_placeholder: 'Placeholder',
    meetings_open_tab: 'Placeholder',
    ...
    finance_expenses: 'Placeholder',
    projects_toast_project_archived: 'Placeholder',
    meetings_started_at: '開始時間',
    projects_col_backlog: 'Placeholder',
    meetings_open_room: '進入會議室',
    chat_warning_label: 'Placeholder',
    greeting_good_afternoon: 'Placeholder',
    meetings_finished_at: '結束時間',
    meetings_form_title: '標題',
    meetings_end: 'Placeholder',
    projects_filters: 'Placeholder',
    projects_filter_dim_projects: 'Placeholder',
    projects_filter_all_priorities: 'Placeholder',
    ...
    finance_create_type_investment: 'Placeholder',
    dashboard_overview_title: 'Placeholder',
    meetings_search_placeholder: '按標題或項目搜索...',
    finance_empty_state: 'Placeholder',
    chat_queued_toast: 'Placeholder',
    projects_list_task: 'Placeholder',
    dashboard_search_no_results: 'Placeholder',
    meetings_add_participant: 'Placeholder',
    sidebar_status_online: 'Placeholder',
    meetings_external_desc: '會議室已生成。使用按鈕加入或結束會議。',
    chat_nothing_to_send: 'Placeholder',
    projects_create_priority: 'Placeholder',
    projects_edit_project_hint: 'Placeholder',
    projects_task_due: 'Placeholder',
    ...
    action_new_project: 'Placeholder',
    topbar_terminal_ssh: 'Placeholder',
    meetings_no_participants: '尚未添加參與者',
    dashboard_quick_actions: 'Placeholder',
    projects_archived: 'Placeholder',
    finance_by_category: 'Placeholder',
    meetings_obj_alinhamento: 'Placeholder',
    ...
    projects_archive: 'Placeholder',
    meetings_obj_outro: 'Placeholder',
    meetings_scheduled_at: '日期和時間',
    chat_check_api_key_model: 'Placeholder',
    finance_create_title: 'Placeholder',
    finance_revenue: 'Placeholder',
    projects_task_create_title: 'Placeholder',
    meetings_page_size: '每頁條數',
    projects_priority_high: 'Placeholder',
    meetings_table_title: '會議',
    meetings_created_at: '創建時間',
    projects_source_local: 'Placeholder',
    chat_error_label: 'Placeholder',
    meetings_status_planned: 'Placeholder',
    meetings_post_summary: 'Placeholder',
    ...
    projects_filter_due_label: 'Placeholder',
    finance_create_type_expense: 'Placeholder',
    meetings_popup_blocked: '彈出視窗攔截程序阻止了打開會議視窗。請允許此網站的彈出視窗。',
    meetings_post_desc: '會議已結束。您現在可以生成總結、保存到 Obsidian 或創建 Jira 任務。',
    projects_task_project: 'Placeholder',
    projects_priority_low: 'Placeholder',
    meetings_status_active: 'Placeholder',
    meetings_detail_hint: '查看此會議的詳細信息和操作',
    projects_filter_search_placeholder: 'Placeholder',
    topbar_admin: 'Placeholder',
    projects_summary_source: 'Placeholder',
    projects_list: 'Placeholder',
    ...
    projects_category_frontend: 'Placeholder',
    projects_task_ref_url: 'Placeholder',
    meetings_scheduled_at_placeholder: '選擇日期和時間',
    projects_subtitle: 'Placeholder',
    projects_title: 'Placeholder',
    meetings_project: 'Placeholder',
    back_to_dashboard: 'Placeholder',
    ...
    tab_agents: 'Placeholder',
    projects_error_project_required: 'Placeholder',
    meetings_planned_desc: '此會議尚未開始。您可以打開會議室以開始會議。',
    jira_create_issue: 'Placeholder',
    tab_automation: 'Placeholder',
    dashboard_topbar_placeholder: 'Placeholder',
    meetings_filter_period: '時間段',
    meetings_sort_by: '排序方式',
    projects_task_refs_github: 'Placeholder',
    projects_task_ref_key: 'Placeholder',
    projects_unarchive: 'Placeholder',
    ...
    meetings_participant_name: 'Placeholder',
    dashboard_notifications_enabled: 'Placeholder',
    meetings_participant_name_required: '參與者姓名是必填項。',
    projects_col_in_progress: 'Placeholder',
    meetings_details: '詳情',
    projects_error_title_required: 'Placeholder',
    meetings_planned_title: '已計劃的會議',
    meetings_participant_whatsapp: 'Placeholder',
    meetings_project_placeholder: '例如：obreiro, brabus, 300...',
    meetings_required_error: '標題和項目必填。',
    neo_agents_empty: 'Placeholder',
    projects_filter_due_week: 'Placeholder',
    finance_create_amount: 'Placeholder',
    kpi_delta_this_month: 'Placeholder',
  ...
  pt: {
    ...
    cmd_skills: 'Listar skills disponíveis do Neo',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento da interface do Neo.',
    ...
    settings_label_default_panel: 'Painel inicial',
    settings_desc_default_panel: 'Painel aberto na inicialização quando a URL não define outro painel.',
    settings_label_theme: 'Tema',
    settings_label_skin: 'Skin',
  ...
  sidebar_support: 'Suporte',
    ...
    onboarding_title: 'Bem-vindo ao Neo',
    onboarding_lead: 'Uma configuração rápida vai verificar o Neo, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar o Neo e a visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor do Neo.',
    ...
    onboarding_notice_system_ready: 'Neo parece acessível pela interface.',
    onboarding_notice_system_unavailable: 'Neo ainda não está totalmente disponível. O bootstrap pode instalar, mas o setup do provedor pode requerer terminal.',
    onboarding_check_agent: 'Agente Neo',
    ...
    onboarding_notice_setup_already_ready: 'Setup de provedor do Neo já detectado. Pode manter ou substituir.',
    ...
    onboarding_workspace_help: 'Escolha o modelo que o Neo deve usar para novos chats.',
    ...
    meetings_participants: 'Placeholder',
    finance_budgets: 'Placeholder',
    diff_too_large: 'Placeholder',
    chat_connection_lost: 'Placeholder',
    skill_deleted: 'Placeholder',
    automation_development_sub: 'Placeholder',
    terminal_start_failed: 'Placeholder',
    meetings_status_finished: 'Placeholder',
    projects_filter_all_owners: 'Placeholder',
    dashboard_notifications_unsupported: 'Placeholder',
    meetings_title: 'Placeholder',
    meetings_generate_room: 'Placeholder',
    pdf_no_pages: 'Placeholder',
    meetings_copy_link: 'Copiar link',
    settings_unsaved_changes: 'Placeholder',
    projects_category_design: 'Placeholder',
    mcp_field_command: 'Placeholder',
    meetings_no_results: 'Nenhuma reunião encontrada com os filtros atuais.',
    meetings_detail_title: 'Detalhes da Reunião',
    chat_session_reconnected_queued: 'Placeholder',
    composer_queue: 'Placeholder',
    dashboard_notifications_disabled: 'Placeholder',
    dashboard_action_placeholder: 'Placeholder',
    meetings_open_tab: 'Placeholder',
    projects_task_progress: 'Placeholder',
    csv_error: 'Placeholder',
    meetings_new: 'Placeholder',
    jira_sync_success: 'Placeholder',
    yolo_pill_label: 'Placeholder',
    settings_desc_model: 'Placeholder',
    workspace_removed: 'Placeholder',
    finance_create_description: 'Placeholder',
    projects_task_title: 'Placeholder',
    jira_never_synced: 'Placeholder',
    kpi_active_projects: 'Placeholder',
    sidebar_talk_now: 'Placeholder',
    pdf_error: 'Placeholder',
    mcp_saved: 'Placeholder',
    finance_expenses: 'Placeholder',
    model_scope_advisory: 'Placeholder',
    projects_toast_project_archived: 'Placeholder',
    session_batch_archive: 'Placeholder',
    ctx_compress_action: 'Placeholder',
    profile_delete_title: 'Placeholder',
    skill_created: 'Placeholder',
    meetings_started_at: 'Iniciada em',
    projects_col_backlog: 'Placeholder',
    disable_auth_confirm_message: 'Placeholder',
    meetings_open_room: 'Abrir sala',
    chat_warning_label: 'Placeholder',
    greeting_good_afternoon: 'Placeholder',
    cron_duplicated: 'Placeholder',
    excalidraw_empty: 'Placeholder',
    model_scope_toast: 'Placeholder',
    terminal_restart: 'Placeholder',
    meetings_finished_at: 'Finalizada em',
    meetings_form_title: 'Título',
    meetings_end: 'Placeholder',
    projects_filters: 'Placeholder',
    skill_updated: 'Placeholder',
    mcp_field_args: 'Placeholder',
    workspace_renamed: 'Placeholder',
    projects_filter_dim_projects: 'Placeholder',
    projects_filter_all_priorities: 'Placeholder',
    projects_list_source: 'Placeholder',
    projects_summary_no_tasks: 'Placeholder',
    ...
    projects_create_name: 'Placeholder',
    finance_create_type_investment: 'Placeholder',
    session_select_all: 'Placeholder',
    dashboard_overview_title: 'Placeholder',
    cmd_terminal: 'Placeholder',
    meetings_search_placeholder: 'Buscar por título ou projeto...',
    finance_empty_state: 'Placeholder',
    chat_queued_toast: 'Placeholder',
    projects_list_task: 'Placeholder',
    dashboard_search_no_results: 'Placeholder',
    active_conversation_none: 'Placeholder',
    meetings_add_participant: 'Placeholder',
    sidebar_status_online: 'Placeholder',
    meetings_external_desc: 'A sala foi gerada. Use os botões para entrar ou encerrar a reunião.',
    chat_nothing_to_send: 'Placeholder',
    excalidraw_invalid: 'Placeholder',
    projects_create_priority: 'Placeholder',
    projects_edit_project_hint: 'Placeholder',
    projects_task_due: 'Placeholder',
    projects_need_project_first: 'Placeholder',
    workspace_reorder_failed: 'Placeholder',
    mcp_command_required: 'Placeholder',
    projects_summary_kpis: 'Placeholder',
    jira_syncing: 'Placeholder',
    csv_no_data: 'Placeholder',
    finance_net_balance: 'Placeholder',
    mcp_cancel: 'Placeholder',
    meetings_title_placeholder: 'Ex: Sprint Review, Briefing...',
    excalidraw_loading: 'Placeholder',
    disable_auth_failed: 'Placeholder',
    projects_list_pager_empty: 'Placeholder',
    projects_category_backend: 'Placeholder',
    action_deploy_project: 'Placeholder',
    finance_recent_transactions: 'Placeholder',
    meetings_next: 'Próximo',
    media_video_label: 'Placeholder',
    mcp_transport_label: 'Placeholder',
    projects_create_domain: 'Placeholder',
    projects_category_infra: 'Placeholder',
    finance_create_category: 'Placeholder',
    pdf_loading: 'Placeholder',
    projects_save: 'Placeholder',
    composer_disabled_compression: 'Placeholder',
    dashboard_shortcuts_desc: 'Placeholder',
    profile_delete_confirm_title: 'Placeholder',
    meetings_obj_suporte: 'Placeholder',
    cmd_yolo: 'Placeholder',
    meetings_status_processed: 'Placeholder',
    projects_filter_dim_priorities: 'Placeholder',
    profile_no_configuration: 'Placeholder',
    projects_edit_title: 'Placeholder',
    dashboard_shortcuts_title: 'Placeholder',
    neo_projects_placeholder: 'Placeholder',
    workspace_paths_validated_hint: 'Placeholder',
    workspace_choose_path_meta: 'Placeholder',
    projects_kanban: 'Placeholder',
    auth_disabled: 'Placeholder',
    meetings_participant_remove: 'Placeholder',
    profiles_no_profiles: 'Placeholder',
    profile_skill_count: 'Placeholder',
    pull_to_refresh: 'Placeholder',
    meetings_obj_homologacao: 'Placeholder',
    meetings_obj_fechamento_sprint: 'Placeholder',
    session_batch_delete_confirm: 'Placeholder',
    kpi_all_operational: 'Placeholder',
    automation_development_title: 'Placeholder',
    chat_no_response_received: 'Placeholder',
    projects_list_project: 'Placeholder',
    session_selected_count: 'Placeholder',
    projects_task_external_ref: 'Placeholder',
    html_sandbox_label: 'Placeholder',
    action_new_project: 'Placeholder',
    topbar_terminal_ssh: 'Placeholder',
    excalidraw_download: 'Placeholder',
    mcp_save_failed: 'Placeholder',
    meetings_no_participants: 'Nenhum participante adicionado ainda',
    composer_interrupt: 'Placeholder',
    dashboard_quick_actions: 'Placeholder',
    projects_archived: 'Placeholder',
    finance_by_category: 'Placeholder',
    mcp_field_timeout: 'Placeholder',
    terminal_input_failed: 'Placeholder',
    diff_loading: 'Placeholder',
    delete_dir_confirm: 'Placeholder',
    meetings_obj_alinhamento: 'Placeholder',
    projects_link_session: 'Placeholder',
    finance_create_date: 'Placeholder',
    projects_create_description: 'Placeholder',
    disable_auth_confirm_title: 'Placeholder',
    neo_tasks_placeholder: 'Placeholder',
    projects_priority_medium: 'Placeholder',
    archive_extracted: 'Placeholder',
    yolo_no_session: 'Placeholder',
    profile_active: 'Placeholder',
    yolo_enabled: 'Placeholder',
    profile_created: 'Placeholder',
    projects_category_docs: 'Placeholder',
    projects_summary_recent: 'Placeholder',
    projects_filter_due_none: 'Placeholder',
    terminal_copy_failed: 'Placeholder',
    projects_task_edit_title: 'Placeholder',
    finance_create_type_revenue: 'Placeholder',
    raw_view: 'Placeholder',
    tab_projects: 'Placeholder',
    projects_task_ref_type: 'Placeholder',
    meetings_role_team: 'Placeholder',
    html_error: 'Placeholder',
    projects_task_status: 'Placeholder',
    clarify_unavailable_toast: 'Placeholder',
    meetings_prev: 'Anterior',
    active_conversation_meta: 'Placeholder',
    bg_error_single: 'Placeholder',
    finance_title: 'Placeholder',
    meetings_filter_project: 'Projeto/Cliente',
    projects_error_save: 'Placeholder',
    mcp_servers_title: 'Placeholder',
    clarify_unavailable_status: 'Placeholder',
    kpi_delta_this_week: 'Placeholder',
    projects_filter_all_sources: 'Placeholder',
    meetings_participant_email: 'Placeholder',
    session_batch_archive_confirm: 'Placeholder',
    greeting_good_morning: 'Placeholder',
    workspace_manage: 'Placeholder',
    excalidraw_too_large: 'Placeholder',
    finance_period_quarter: 'Placeholder',
    excalidraw_simplified: 'Placeholder',
    terminal_close: 'Placeholder',
    tab_tasks: 'Placeholder',
    profile_name_rule: 'Placeholder',
    greeting_good_evening: 'Placeholder',
    projects_task_refs_sessions: 'Placeholder',
    projects_category_security: 'Placeholder',
    finance_create_submit: 'Placeholder',
    composer_disabled_clarify: 'Placeholder',
    development_badge: 'Placeholder',
    projects_task_category: 'Placeholder',
    finance_create_recurrence: 'Placeholder',
    projects_list_owner: 'Placeholder',
    automation_development_note: 'Placeholder',
    diff_error: 'Placeholder',
    meetings_objective: 'Placeholder',
    projects_category_database: 'Placeholder',
    kpi_tasks_in_progress: 'Placeholder',
    chat_reconnecting: 'Placeholder',
    profile_switch_title: 'Placeholder',
    meetings_role_host: 'Placeholder',
    projects_toast_task_unarchived: 'Placeholder',
    jira_create_success: 'Placeholder',
    meetings_obj_briefing: 'Placeholder',
    ...
    projects_archive: 'Placeholder',
    meetings_obj_outro: 'Placeholder',
    meetings_scheduled_at: 'Data e hora',
    chat_check_api_key_model: 'Placeholder',
    finance_create_title: 'Placeholder',
    terminal_collapse: 'Placeholder',
    workspace_drag_hint: 'Placeholder',
    terminal_open_title: 'Placeholder',
    finance_revenue: 'Placeholder',
    workspace_choose_path: 'Placeholder',
    projects_task_create_title: 'Placeholder',
    session_batch_move: 'Placeholder',
    meetings_page_size: 'Itens por página',
    projects_priority_high: 'Placeholder',
    session_batch_delete: 'Placeholder',
    meetings_table_title: 'Reuniões',
    meetings_created_at: 'Criada em',
    projects_source_local: 'Placeholder',
    chat_error_label: 'Placeholder',
    mcp_delete_confirm_message: 'Placeholder',
    meetings_status_planned: 'Placeholder',
    tree_view: 'Placeholder',
    media_svg_label: 'Placeholder',
    meetings_post_summary: 'Placeholder',
    neo_agents_empty_sub: 'Placeholder',
    projects_filters_apply: 'Placeholder',
    projects_filter_due_overdue: 'Placeholder',
    meetings_filter_status: 'Status',
    tab_settings: 'Placeholder',
    workspace_added: 'Placeholder',
    finance_new: 'Placeholder',
    projects_list_status: 'Placeholder',
    jira_sync_error: 'Placeholder',
    terminal_expand: 'Placeholder',
    session_no_selection: 'Placeholder',
    greeting_welcome_back: 'Placeholder',
    projects_create_color: 'Placeholder',
    kpi_completed: 'Placeholder',
    projects_list_id: 'Placeholder',
    tab_dashboard: 'Placeholder',
    topbar_help: 'Placeholder',
    neo_tasks_subtitle: 'Placeholder',
    projects_col_completed: 'Placeholder',
    mcp_save: 'Placeholder',
    sidebar_docs: 'Placeholder',
    projects_category_devops: 'Placeholder',
    mcp_url_required: 'Placeholder',
    projects_add_task: 'Placeholder',
    session_select_mode_desc: 'Placeholder',
    skill_delete_confirm: 'Placeholder',
    projects_filter_due_label: 'Placeholder',
    finance_create_type_expense: 'Placeholder',
    meetings_popup_blocked: 'O bloqueador de popups impediu a abertura da janela da reunião. Por favor, permita popups para este site.',
    meetings_post_desc: 'Esta reunião terminou. Agora você pode gerar um resumo, salvar no Obsidian ou criar tarefas no Jira.',
    projects_task_project: 'Placeholder',
    composer_stop: 'Placeholder',
    profile_use: 'Placeholder',
    yolo_pill_title_active: 'Placeholder',
    projects_priority_low: 'Placeholder',
    composer_steer: 'Placeholder',
    tab_chat: 'Placeholder',
    cron_duplicate: 'Placeholder',
    meetings_status_active: 'Placeholder',
    meetings_detail_hint: 'Visualizar detalhes e ações para esta reunião',
    projects_filter_search_placeholder: 'Placeholder',
    mcp_servers_desc: 'Placeholder',
    topbar_admin: 'Placeholder',
    projects_summary_source: 'Placeholder',
    session_select_mode: 'Placeholder',
    projects_list: 'Placeholder',
    neo_finance_placeholder: 'Placeholder',
    projects_error_load: 'Placeholder',
    action_new_document: 'Placeholder',
    projects_summary_no_project: 'Placeholder',
    tab_conversations: 'Placeholder',
    projects_col_in_review: 'Placeholder',
    mcp_add_server: 'Placeholder',
    dashboard_search_hint: 'Placeholder',
    projects_create_title: 'Placeholder',
    projects_task_priority: 'Placeholder',
    projects_summary_jira_issues: 'Placeholder',
    rename_prompt: 'Placeholder',
    projects_total: 'Placeholder',
    finance_goals: 'Placeholder',
    profile_gateway_stopped: 'Placeholder',
    projects_filter_dim_status: 'Placeholder',
    hero_status_online: 'Placeholder',
    terminal_no_workspace_title: 'Placeholder',
    parse_failed_note: 'Placeholder',
    projects_empty_sub: 'Placeholder',
    mcp_delete_confirm_title: 'Placeholder',
    projects_unarchive_project_confirm: 'Placeholder',
    chat_uploading: 'Placeholder',
    composer_send: 'Placeholder',
    chat_upload_error_prefix: 'Placeholder',
    chat_rate_limit_reached: 'Placeholder',
    projects_summary_links: 'Placeholder',
    neo_agents_subtitle: 'Placeholder',
    ...
    meetings_role_guest: 'Placeholder',
    projects_toast_task_saved: 'Placeholder',
    skill_name_required: 'Placeholder',
    tab_finance: 'Placeholder',
    chat_out_of_credits: 'Placeholder',
    terminal_library_failed: 'Placeholder',
    excalidraw_render_error: 'Placeholder',
    projects_category_frontend: 'Placeholder',
    projects_task_ref_url: 'Placeholder',
    meetings_scheduled_at_placeholder: 'Selecione data e hora',
    projects_subtitle: 'Placeholder',
    mcp_field_url: 'Placeholder',
    projects_title: 'Placeholder',
    ...
    jira_last_sync: 'Placeholder',
    projects_filter_dim_sources: 'Placeholder',
    rename_title: 'Placeholder',
    action_new_component: 'Placeholder',
    projects_task_save: 'Placeholder',
    meetings_external_title: 'Reunião em andamento',
    meetings_post_jira: 'Placeholder',
    dashboard_updated: 'Placeholder',
    chat_error_generic: 'Placeholder',
    finance_subtitle: 'Placeholder',
    projects_filter_due_any: 'Placeholder',
    html_open_full: 'Placeholder',
    terminal_input_placeholder: 'Placeholder',
    csv_too_large: 'Placeholder',
    excalidraw_label: 'Placeholder',
    action_generate_report: 'Placeholder',
    meetings_post_title: 'Placeholder',
    finance_investments: 'Placeholder',
    session_deselect_all: 'Placeholder',
    projects_toast_task_created: 'Placeholder',
    projects_archive_project_confirm: 'Placeholder',
    projects_filters_clear_all: 'Placeholder',
    projects_move_to: 'Placeholder',
    terminal_error: 'Placeholder',
    projects_error_name_required: 'Placeholder',
    mcp_no_servers: 'Placeholder',
    projects_summary_status: 'Placeholder',
    profile_default_label: 'Placeholder',
    projects_summary_created: 'Placeholder',
    projects_toast_project_unarchived: 'Placeholder',
    projects_task_refs_obsidian: 'Placeholder',
    pdf_too_large: 'Placeholder',
    projects_unarchive_project: 'Placeholder',
    projects_list_per_page: 'Placeholder',
    projects_summary_completion: 'Placeholder',
    bg_error_multi: 'Placeholder',
    projects_summary_domain: 'Placeholder',
    profile_base_url_rule: 'Placeholder',
    greeting_summary: 'Placeholder',
    profile_delete_confirm_message: 'Placeholder',
    tab_agents: 'Placeholder',
    projects_error_project_required: 'Placeholder',
    meetings_planned_desc: 'Esta reunião ainda não começou. Você pode abrir a sala para iniciá-la.',
    jira_create_issue: 'Placeholder',
    profile_api_keys_configured: 'Placeholder',
    mcp_name_required: 'Placeholder',
    tab_automation: 'Placeholder',
    profile_clone_label: 'Placeholder',
    dashboard_topbar_placeholder: 'Placeholder',
    meetings_filter_period: 'Período',
    meetings_sort_by: 'Ordenar por',
    yolo_disabled: 'Placeholder',
    projects_task_refs_github: 'Placeholder',
    projects_task_ref_key: 'Placeholder',
    workspace_remove_confirm_title: 'Placeholder',
    mcp_deleted: 'Placeholder',
    projects_unarchive: 'Placeholder',
    terminal_copy_output: 'Placeholder',
    projects_filter_dim_owners: 'Placeholder',
    projects_toast_project_created: 'Placeholder',
    topbar_notifications: 'Placeholder',
    jira_sync: 'Placeholder',
    ctx_compress_hint: 'Placeholder',
    meetings_participant_name: 'Placeholder',
    dashboard_notifications_enabled: 'Placeholder',
    meetings_participant_name_required: 'O nome do participante é obrigatório.',
    projects_col_in_progress: 'Placeholder',
    meetings_details: 'Detalhes',
    tab_skills: 'Placeholder',
    projects_error_title_required: 'Placeholder',
    meetings_planned_title: 'Reunião Agendada',
    mcp_field_name: 'Placeholder',
    refreshing: 'Placeholder',
    meetings_participant_whatsapp: 'Placeholder',
    meetings_project_placeholder: 'Ex: obreiro, brabus, 300...',
    meetings_required_error: 'Título e projeto são obrigatórios.',
    neo_agents_empty: 'Placeholder',
    html_too_large: 'Placeholder',
    projects_filter_due_week: 'Placeholder',
    finance_create_amount: 'Placeholder',
    kpi_delta_this_month: 'Placeholder',
    sidebar_support: 'Placeholder',
    media_audio_label: 'Placeholder',
    projects_create_category: 'Placeholder',
    meetings_actions: 'Ações',
    topbar_search: 'Placeholder',
    mcp_delete_failed: 'Placeholder',
    projects_task_description: 'Placeholder',
    csv_loading: 'Placeholder',
    projects_summary_info: 'Placeholder',
    workspace_add_path_placeholder: 'Placeholder',
    projects_create_default_source: 'Placeholder',
    projects_toast_task_archived: 'Placeholder',
    meetings_role_client: 'Placeholder',
    projects_task_links: 'Placeholder',
    projects_toast_project_saved: 'Placeholder',
    excalidraw_error: 'Placeholder',
    profile_gateway_running: 'Placeholder',
    projects_list_pager_summary: 'Placeholder',
    projects_new: 'Placeholder',
    projects_show_archived: 'Placeholder',
    mcp_load_failed: 'Placeholder',
    workspace_manage_meta: 'Placeholder',
    workspace_remove_confirm_message: 'Placeholder',
    html_loading: 'Placeholder',
    action_new_meeting: 'Placeholder',
    tab_meetings: 'Placeholder',
    composer_disabled_empty: 'Placeholder',
    finance_create_notes: 'Placeholder',
    pdf_download: 'Placeholder',
  },
  ko: {
    _lang: 'ko',
    _label: '한국어',
    ...
    settings_section_preferences_meta: 'Neo의 기본값과 UI 동작.',
    ...
    settings_label_default_panel: '기본 패널',
    settings_desc_default_panel: 'URL에서 다른 패널을 지정하지 않았을 때 시작 시 열리는 패널입니다.',
    ...
    onboarding_lead: '간단한 안내 설정으로 Neo 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
    ...
    projects_toast_task_created: 'Task created.',
    projects_toast_task_saved: 'Task saved.',
    projects_view_summary: '요약',
    projects_summary_info: '프로젝트 정보',
    projects_summary_kpis: 'KPIs',
    projects_summary_links: '외부 링크',
    projects_summary_recent: '최근 활동',
    projects_summary_jira_issues: 'Jira Issues',
    projects_summary_completion: '완료',
    projects_summary_no_project: '프로젝트를 선택하여 요약을 확인하세요',
    projects_summary_no_tasks: '아직 작업이 없습니다',
    projects_summary_domain: '도메인',
    projects_summary_status: '상태',
    projects_summary_created: '생성일',
    projects_summary_source: '소스',
    jira_sync: '동기화',
    jira_syncing: '동기화 중…',
    jira_sync_success: '동기화 완료',
    jira_sync_error: '동기화 실패',
    jira_last_sync: '마지막 동기화',
    jira_create_issue: 'Jira에 생성',
    jira_create_success: 'Issue 생성됨',
    jira_chip: 'JIRA',
    jira_never_synced: '동기화한 적 없음',
    tab_meetings: '회의',
    action_new_meeting: '새 회의',
    meetings_title: '회의',
    meetings_subtitle: '프로젝트 회의를 만들고 관리하세요',
    meetings_new: '새 회의',
    meetings_project: '프로젝트 / 고객',
    meetings_objective: '목표',
    meetings_participants: '참가자',
    meetings_generate_room: '방 생성',
    meetings_open_tab: '새 탭에서 열기',
    meetings_end: '회의 종료',
    meetings_status_planned: '예정됨',
    meetings_status_active: '진행 중',
    meetings_status_finished: '종료됨',
    meetings_status_processed: '처리됨',
    meetings_post_title: '회의 후',
    meetings_post_summary: '요약 생성',
    meetings_post_obsidian: 'Obsidian에 저장',
    meetings_post_jira: 'Jira 작업 생성',
    meetings_empty: '아직 회의가 없습니다. 첫 번째 회의를 만드세요!',
    meetings_obj_alinhamento: '정렬',
    meetings_obj_homologacao: '검증',
    meetings_obj_fechamento_sprint: '스프린트 마감',
    meetings_obj_briefing: '브리핑',
    meetings_obj_suporte: '지원',
    meetings_obj_outro: '기타',
    meetings_add_participant: '참가자 추가',
    meetings_participant_name: '이름',
    meetings_participant_email: '이메일',
    meetings_participant_whatsapp: 'WhatsApp',
    meetings_participant_role: '역할',
    meetings_role_host: '호스트',
    meetings_role_client: '고객',
    meetings_role_team: '팀',
    meetings_role_guest: '게스트',
    meetings_participant_remove: '삭제',
    meetings_copy_link: '링크 복사',
    meetings_no_results: '현재 필터와 일치하는 회의가 없습니다.',
    meetings_detail_title: '회의 상세 정보',
    meetings_started_at: '시작일',
    meetings_open_room: '방 열기',
    meetings_finished_at: '종료일',
    meetings_form_title: '제목',
    meetings_search_placeholder: '제목 또는 프로젝트로 검색...',
    meetings_external_desc: '회의실이 생성되었습니다. 가입 또는 회의 종료 버튼을 사용하십시오.',
    meetings_title_placeholder: '예: 스프린트 검토, 브리핑...',
    meetings_next: '다음',
    meetings_no_participants: '참가자가 아직 추가되지 않았습니다',
    meetings_prev: '이전',
    meetings_filter_project: '프로젝트/고객',
    meetings_scheduled_at: '날짜 및 시간',
    meetings_page_size: '페이지당 항목 수',
    meetings_table_title: '회의',
    meetings_created_at: '생성일',
    meetings_filter_status: '상태',
    meetings_popup_blocked: '팝업 차단기로 인해 회의 창을 열지 못했습니다. 이 사이트의 팝업을 허용해 주십시오.',
    meetings_post_desc: '이 회의가 종료되었습니다. 이제 요약을 생성하거나 Obsidian에 저장하거나 Jira 작업을 만들 수 있습니다.',
    meetings_detail_hint: '이 회의의 상세 정보 및 작업 보기',
    meetings_scheduled_at_placeholder: '날짜 및 시간 선택',
    meetings_external_title: '회의 진행 중',
    meetings_planned_desc: '이 회의는 아직 시작되지 않았습니다. 대화방을 열어 시작할 수 있습니다.',
    meetings_filter_period: '기간',
    meetings_sort_by: '정렬 기준',
    meetings_participant_name_required: '참가자 이름은 필수입니다.',
    meetings_details: '상세 정보',
    meetings_planned_title: '예정된 회의',
    meetings_project_placeholder: '예: obreiro, brabus, 300...',
    meetings_required_error: '제목과 프로젝트가 필요합니다.',
    meetings_actions: '작업',
  },
};

// NEO: Brazilian Portuguese locale completes the upstream pt bundle without
// duplicating the full locale. Keep explicit overrides for keys that pt lacks.
LOCALES['pt-BR'] = {
  ...LOCALES.pt,
  _lang: 'pt-BR',
  ...
  archive_extracted: (n, c) => `${n} arquivo(s) extraído(s) de ${c} arquivo(s) compactado(s)`,
  auth_disabled: 'Autenticação desativada — proteção por senha removida',
  bg_error_multi: (count) => `${count} sessões encontraram erro`,
  bg_error_single: (title) => `"${title}" encontrou um erro`,
  cmd_terminal: 'Abrir o terminal do workspace',
  cmd_yolo: 'Alternar modo YOLO (pular aprovações)',
  composer_disabled_clarify: 'Responda à solicitação de esclarecimento',
  composer_disabled_compression: 'Aguardando a compressão terminar',
  ...
  composer_steer: 'Orientar resposta atual',
  composer_stop: 'Parar geração',
  chat_queued_toast: (text) => `Enfileirado: "${text}"`,
  chat_session_reconnected_queued: 'A sessão atual ainda está em execução. Reconectei e enfileirei sua mensagem.',
  chat_uploading: 'Enviando…',
  chat_upload_error_prefix: 'Erro no upload: ',
  chat_nothing_to_send: 'Nada para enviar',
  chat_error_generic: 'Ocorreu um erro. Verifique os logs do servidor.',
  chat_error_label: 'Erro',
  chat_connection_lost: 'Conexão perdida',
  chat_warning_label: 'Aviso',
  chat_reconnecting: 'Reconectando…',
  chat_reconnected: 'Reconectado',
  chat_context_compressed: 'Contexto comprimido',
  chat_out_of_credits: 'Créditos esgotados',
  chat_rate_limit_reached: 'Limite de taxa atingido',
  chat_no_response_received: 'Nenhuma resposta recebida',
  chat_check_api_key_model: 'Verifique sua chave de API e a seleção de modelo.',
  clarify_unavailable_status: 'Esclarecimento indisponível nesta build do servidor. Reinicie o servidor.',
  clarify_unavailable_toast: 'Endpoint de esclarecimento indisponível. Reinicie o servidor.',
  terminal_library_failed: 'Falha ao carregar a biblioteca do terminal. Verifique o acesso de rede a cdn.jsdelivr.net.',
  cron_duplicate: 'Duplicar',
  cron_duplicated: 'Job duplicado (pausado)',
  csv_error: 'Falha ao carregar arquivo CSV',
  csv_header_note: 'Primeira linha exibida como cabeçalho da tabela',
  csv_loading: 'Carregando CSV',
  csv_no_data: 'O arquivo CSV não tem dados suficientes para renderizar como tabela',
  csv_too_large: 'Arquivo CSV grande demais para renderização inline',
  ctx_compress_action: '⚠ Comprimir agora para liberar contexto',
  ctx_compress_hint: 'Comprima o contexto para liberar espaço →',
  delete_dir_confirm: (name) => `Excluir a pasta "${name}" e todo o seu conteúdo?`,
  diff_error: 'Não foi possível carregar o arquivo de patch',
  diff_loading: 'Carregando diff',
  diff_too_large: 'Patch grande demais para exibir inline',
  ...
  excalidraw_download: 'Baixar',
  excalidraw_empty: 'Diagrama vazio',
  excalidraw_error: 'Falha ao carregar arquivo Excalidraw',
  excalidraw_invalid: 'Formato de arquivo Excalidraw inválido',
  excalidraw_label: 'Diagrama',
  excalidraw_loading: 'Carregando diagrama',
  excalidraw_render_error: 'Falha ao renderizar diagrama',
  excalidraw_simplified: 'Prévia SVG simplificada — não é pixel a pixel idêntica ao canvas do Excalidraw',
  excalidraw_too_large: 'Arquivo Excalidraw grande demais para renderização inline',
  html_error: 'Falha ao renderizar prévia HTML',
  html_loading: 'Carregando prévia HTML…',
  html_open_full: 'Abrir página completa',
  html_sandbox_label: 'Prévia HTML (sandbox)',
  html_too_large: 'HTML grande demais para prévia inline',
  mcp_add_server: '+ Adicionar servidor',
  mcp_cancel: 'Cancelar',
  mcp_command_required: 'Comando obrigatório para transporte stdio.',
  mcp_delete_confirm_message: 'Excluir servidor MCP "{0}"? Esta ação não pode ser desfeita.',
  ...
  mcp_name_required: 'Nome do servidor é obrigatório.',
  mcp_no_servers: 'Nenhum servidor MCP configurado.',
  mcp_save: 'Salvar',
  mcp_save_failed: 'Falha ao salvar servidor MCP.',
  mcp_saved: 'Servidor MCP salvo.',
  mcp_servers_desc: 'Gerencie servidores MCP configurados no config.yaml.',
  mcp_servers_title: 'Servidores MCP',
  mcp_transport_label: 'Tipo de transporte',
  mcp_url_required: 'URL obrigatória para transporte HTTP.',
  media_audio_label: 'Áudio',
  media_svg_label: 'Diagrama',
  media_video_label: 'Vídeo',
  model_scope_advisory: 'Aplica-se a esta conversa a partir da sua próxima mensagem.',
  model_scope_toast: 'Aplica-se a esta conversa a partir da sua próxima mensagem.',
  parse_failed_note: 'falha ao analisar',
  pdf_download: 'Baixar PDF',
  pdf_error: 'Falha ao renderizar prévia do PDF',
  pdf_loading: 'Carregando PDF {0}…',
  pdf_no_pages: 'O PDF não tem páginas',
  pdf_too_large: 'PDF grande demais para prévia inline',
  profile_active: 'ativo',
  profile_api_keys_configured: 'Chaves de API configuradas',
  profile_base_url_rule: 'A URL base deve começar com http:// ou https://',
  profile_clone_label: 'Clonar configuração do perfil ativo',
  profile_created: (name) => `Perfil criado: ${name}`,
  profile_default_label: '(padrão)',
  profile_delete_confirm_message: 'Todas as sessões, configurações, skills e memórias deste perfil serão excluídas permanentemente. Esta ação não pode ser desfeita.',
  profile_delete_confirm_title: (name) => `Excluir perfil "${name}"?`,
  profile_delete_title: 'Excluir este perfil',
  profile_gateway_running: 'Gateway em execução',
  profile_gateway_stopped: 'Gateway parado',
  profile_name_rule: 'Somente letras minúsculas, números, hífens e underscores',
  profile_no_configuration: 'Sem configuração',
  profile_skill_count: (count) => `${count} skill${count === 1 ? '' : 's'}`,
  profile_switch_title: 'Alternar para este perfil',
  profile_use: 'Usar',
  profiles_no_profiles: 'Nenhum perfil encontrado.',
  raw_view: 'Bruto',
  rename_prompt: 'Novo nome:',
  rename_title: 'Renomear',
  session_batch_archive: 'Arquivar',
  session_batch_archive_confirm: 'Arquivar {0} conversas?',
  session_batch_delete: 'Excluir',
  session_batch_delete_confirm: 'Excluir {0} conversas?',
  session_batch_move: 'Mover para projeto',
  session_deselect_all: 'Desmarcar tudo',
  session_no_selection: 'Nenhuma conversa selecionada',
  session_select_all: 'Selecionar tudo',
  session_select_mode: 'Selecionar',
  session_select_mode_desc: 'Selecione conversas para gerenciar em lote',
  session_selected_count: '{0} selecionada(s)',
  settings_desc_model: 'Usado para novas conversas. Conversas existentes mantêm o modelo selecionado.',
  settings_unsaved_changes: 'Você tem alterações não salvas.',
  sign_out_failed: 'Falha ao sair: ',
  skill_created: 'Skill criada',
  skill_delete_confirm: 'Excluir skill "{0}"?',
  skill_deleted: 'Skill excluída',
  skill_name_required: 'Nome da skill é obrigatório',
  ...
  terminal_copy_output: 'Copiar saída',
  terminal_error: 'Erro no terminal',
  terminal_expand: 'Expandir',
  terminal_input_failed: 'Falha ao enviar comando ao terminal: ',
  terminal_input_placeholder: 'Execute um comando...',
  terminal_no_workspace_title: 'Selecione um workspace para abrir o terminal',
  terminal_open_title: 'Abrir terminal do workspace',
  terminal_restart: 'Reiniciar',
  terminal_start_failed: 'Falha ao iniciar terminal: ',
  terminal_title: 'Terminal',
  tree_view: 'Árvore',
  workspace_add_path_placeholder: 'Adicionar caminho de workspace (ex: /home/user/meu-projeto)',
  workspace_added: 'Workspace adicionado',
  workspace_choose_path: 'Escolha o caminho do workspace',
  workspace_choose_path_meta: 'Adicione um caminho validado e alterne esta conversa',
  workspace_drag_hint: 'Arraste para reordenar',
  workspace_manage: 'Gerenciar espaços',
  workspace_manage_meta: 'Abrir painel Spaces',
  workspace_paths_validated_hint: 'Os caminhos são validados como diretórios existentes antes de salvar.',
  workspace_remove_confirm_message: (path) => `Remover "${path}"?`,
  ...
  workspace_reorder_failed: 'Falha ao reordenar',
  yolo_disabled: 'Modo YOLO desligado',
  yolo_enabled: '⚡ Modo YOLO ligado — aprovações ignoradas nesta sessão',
  yolo_no_session: 'Nenhuma sessão ativa',
  yolo_pill_label: 'YOLO',
  yolo_pill_title_active: 'Modo YOLO ativo — clique para desativar',

  // ── Neo WebUI: Dashboard, Projects, Finances ───────────────────────────
  dashboard_overview_title: 'Neo WebUI',
  dashboard_overview_desc: 'Console operacional para acompanhar contexto, tarefas e espaços de trabalho.',
  dashboard_updated: 'Atualizado',
  dashboard_shortcuts_title: 'Atalhos',
  dashboard_shortcuts_desc: 'Acesso direto aos painéis principais sem alterar o fluxo do chat.',
  kpi_active_projects: 'Projetos Ativos',
  kpi_tasks_in_progress: 'Tarefas em Andamento',
  kpi_completed: 'Concluídas',
  kpi_agents_online: 'Agentes Online',
  kpi_delta_this_month: (n) => `+${Number(n || 0)} este mês`,
  kpi_delta_since_yesterday: (n) => `+${Number(n || 0)} desde ontem`,
  kpi_delta_this_week: (n) => `+${Number(n || 0)} esta semana`,
  kpi_all_operational: 'Todos operacionais',
  dashboard_quick_actions: 'Ações Rápidas',
  dashboard_action_placeholder: 'Ação preparada no chat enquanto o fluxo dedicado de backend está pendente.',
  action_new_project: 'Novo Projeto',
  action_new_document: 'Novo Documento',
  action_new_component: 'Novo Componente',
  action_open_terminal: 'Abrir Terminal',
  action_generate_report: 'Gerar Relatório',
  action_deploy_project: 'Deploy Projeto',
  ...
  meetings_add_participant: 'Adicionar Participante',
  meetings_participant_name: 'Nome',
  meetings_participant_email: 'Email',
  meetings_participant_whatsapp: 'WhatsApp',
  meetings_participant_role: 'Função',
  meetings_role_host: 'Anfitrião',
  meetings_role_client: 'Cliente',
  meetings_role_team: 'Equipe',
  meetings_role_guest: 'Convidado',
  meetings_participant_remove: 'Remover',
  meetings_form_title: 'Título',
  meetings_title_placeholder: 'Ex: Reunião Produção — Alinhamento Cliente',
  meetings_project_placeholder: 'Ex: Produção, Brabus, Obreiro',
  meetings_scheduled_at: 'Data e hora',
  meetings_scheduled_at_placeholder: 'Selecione data e hora',
  meetings_required_error: 'Informe título e projeto/cliente.',
  meetings_table_title: 'Reuniões',
  meetings_search_placeholder: 'Buscar por título ou projeto...',
  meetings_filter_status: 'Status',
  meetings_filter_project: 'Projeto/Cliente',
  ...
  meetings_page_size: 'Itens por página',
  meetings_prev: 'Anterior',
  meetings_next: 'Próxima',
  sidebar_talk_now: 'Conversar agora',
  topbar_vps_status: 'Status VPS',
  topbar_terminal_ssh: 'Terminal SSH',
  topbar_search: 'Buscar',
  topbar_notifications: 'Notificações',
  topbar_help: 'Ajuda',
  topbar_admin: 'Admin',
  dashboard_topbar_placeholder: 'Este controle é um placeholder visual para o próximo fluxo operacional.',
  dashboard_search_hint: 'Digite para buscar conversas por título ou conteúdo recente.',
  dashboard_search_no_results: 'Nenhuma conversa encontrada.',
  dashboard_notifications_enabled: 'Notificações do navegador estão ativas para respostas concluídas em background.',
  ...
  neo_finance_placeholder: 'O shell visual de finanças entra na Sprint 4. Este link já reserva o painel correto no shell Neo.',
  ...
  greeting_good_morning: 'Bom dia!',
  greeting_good_afternoon: 'Boa tarde!',
  greeting_good_evening: 'Boa noite!',
  greeting_welcome_back: 'Bem-vindo de volta! 👋',
  greeting_summary: 'Aqui está o resumo do que está acontecendo com seus projetos.',
  hero_status_online: 'STATUS: OPERACIONAL',
  projects_title: 'Projetos',
  projects_subtitle: 'Gerencie e acompanhe o progresso dos seus projetos',
  projects_filters: 'Filtros',
  projects_kanban: 'Kanban',
  projects_new: '+ Novo Projeto',
  projects_col_backlog: 'Backlog',
  projects_col_in_progress: 'Em Andamento',
  projects_col_in_review: 'Em Revisão',
  projects_col_completed: 'Concluído',
  projects_add_task: '+ Adicionar tarefa',
  projects_total: 'Total',
  projects_category_design: 'Design',
  projects_category_frontend: 'Frontend',
  projects_category_backend: 'Backend',
  ...
  projects_category_docs: 'Docs',
  projects_category_qa: 'QA',
  projects_category_security: 'Segurança',
  projects_priority_low: 'Baixa',
  projects_priority_medium: 'Média',
  projects_priority_high: 'Alta',
  projects_create_title: 'Novo Projeto',
  projects_create_name: 'Nome',
  projects_create_category: 'Categoria',
  projects_create_priority: 'Prioridade',
  projects_create_description: 'Descrição',
  projects_create_submit: 'Criar',
  projects_archive: 'Arquivar',
  projects_unarchive: 'Desarquivar',
  projects_archived: 'Arquivado',
  projects_archive_project: 'Arquivar projeto',
  projects_unarchive_project: 'Desarquivar projeto',
  projects_archive_project_confirm: 'Arquivar este projeto? Ele e suas tarefas saem das contagens ativas.',
  projects_unarchive_project_confirm: 'Desarquivar este projeto?',
  projects_show_archived: 'Mostrar arquivados',
  projects_edit_title: 'Editar Projeto',
  projects_save: 'Salvar',
  projects_edit_project_hint: 'Editar projeto',
  projects_task_links: 'Vínculos',
  projects_task_refs_sessions: 'Sessões',
  projects_task_refs_github: 'GitHub',
  projects_task_refs_obsidian: 'Obsidian',
  projects_task_refs_empty: 'Nenhum vínculo registrado.',
  projects_toast_project_saved: 'Projeto salvo.',
  projects_toast_project_archived: 'Projeto arquivado.',
  projects_toast_project_unarchived: 'Projeto desarquivado.',
  projects_toast_task_archived: 'Tarefa arquivada.',
  projects_toast_task_unarchived: 'Tarefa desarquivada.',
    projects_list: 'Lista',
  projects_list_id: 'ID',
  projects_list_task: 'Tarefa',
  projects_list_project: 'Projeto',
  projects_list_priority: 'Prioridade',
  projects_list_owner: 'Responsável',
  projects_list_status: 'Status',
  projects_list_source: 'Fonte',
  projects_list_per_page: 'Por página',
  projects_list_pager_summary: '{from}–{to} de {total}',
  projects_list_pager_empty: 'Nenhuma tarefa.',
  projects_filter_search_placeholder: 'Buscar tarefa por título, código ou tag…',
  projects_filter_dim_status: 'Status',
  projects_filter_dim_projects: 'Projetos',
  projects_filter_dim_priorities: 'Prioridades',
  projects_filter_dim_sources: 'Fontes',
  projects_filter_dim_owners: 'Responsáveis',
  projects_filter_due_label: 'Prazo',
  projects_filter_due_any: 'Qualquer prazo',
  projects_filter_due_overdue: 'Atrasadas',
  projects_filter_due_week: 'Próximos 7 dias',
  projects_filter_due_none: 'Sem prazo',
  projects_filters_clear_all: 'Limpar tudo',
  projects_filters_apply: 'Aplicar filtros',
  projects_create_color: 'Cor',
  projects_create_domain: 'Domínio',
  projects_create_default_source: 'Fonte externa padrão (opcional)',
  projects_filter_text_placeholder: 'Buscar tarefa, projeto ou ref…',
  projects_filter_all_projects: 'Todos os projetos',
  projects_filter_all_priorities: 'Todas prioridades',
  projects_filter_all_sources: 'Todas fontes',
  projects_filter_all_owners: 'Todos responsáveis',
  projects_source_local: 'Local',
  projects_empty_title: 'Nenhum projeto ainda',
  projects_empty_sub: 'Crie um projeto para começar a organizar tarefas e acompanhar progresso.',
  projects_task_create_title: 'Nova Tarefa',
  projects_task_edit_title: 'Editar Tarefa',
  projects_task_title: 'Título',
  projects_task_project: 'Projeto',
  projects_task_status: 'Status',
  projects_task_category: 'Categoria',
  projects_task_priority: 'Prioridade',
  projects_task_owner: 'Responsável',
  projects_task_due: 'Prazo',
  projects_task_progress: 'Progresso (0-100)',
  projects_task_external_ref: 'Referência externa (opcional)',
  projects_task_ref_type: 'Tipo',
  projects_task_ref_key: 'Chave',
  projects_task_ref_url: 'URL',
  projects_task_ref_none: 'Nenhum',
  projects_task_save: 'Salvar',
  projects_task_description: 'Descrição',
  projects_unassigned: 'Sem projeto',
  projects_need_project_first: 'Crie um projeto antes de adicionar tarefas.',
  projects_error_load: 'Erro ao carregar projetos.',
  projects_error_save: 'Erro ao salvar.',
  projects_error_name_required: 'Nome é obrigatório.',
  projects_error_title_required: 'Título é obrigatório.',
  projects_error_project_required: 'Selecione um projeto.',
  projects_toast_project_created: 'Projeto criado.',
  projects_toast_task_created: 'Tarefa criada.',
  projects_toast_task_saved: 'Tarefa salva.',
  projects_link_session: 'Vincular sessão',
  projects_move_to: 'Mover para',
  // Projects — Summary view
  ...
  finance_subtitle: 'Controle financeiro pessoal e empresarial',
  finance_revenue: 'Receitas',
  finance_expenses: 'Despesas',
  finance_net_balance: 'Saldo Líquido',
  finance_investments: 'Investimentos',
  finance_new: '+ Nova Finança',
  finance_recent_transactions: 'Transações Recentes',
  finance_budgets: 'Orçamentos',
  finance_goals: 'Metas Financeiras',
  finance_empty_state: 'Adicione sua primeira transação',
  finance_by_category: 'Gastos por Categoria',
  finance_period_month: 'Mês',
  finance_period_quarter: 'Trimestre',
  finance_period_year: 'Ano',
  finance_create_title: 'Nova Finança',
  finance_create_type_revenue: 'Receita',
  finance_create_type_expense: 'Despesa',
  finance_create_type_investment: 'Investimento',
  finance_create_description: 'Descrição',
  finance_create_amount: 'Valor',
  finance_create_date: 'Data',
  finance_create_category: 'Categoria',
  finance_create_method: 'Método de pagamento',
  finance_create_recurrence: 'Recorrência',
 ...
 * NEO: when there is no saved user choice, honor the server-injected default
 * locale so first render can start in pt-BR without waiting for /api/settings.
 * Server-persisted preference is still applied later in loadSettingsPanel().
 */
function loadLocale() {
  const saved = localStorage.getItem('hermes-lang');
  const neoDefault = (typeof window !== 'undefined' && window.__neoDefaults && window.__neoDefaults.locale) || null;
  setLocale(resolvePreferredLocale(saved, neoDefault));
}
