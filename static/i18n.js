...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    meetings_detail_hint: 'Click any meeting in the list to inspect it here.',
    meetings_created_at: 'Created',
    meetings_started_at: 'Started',
    meetings_finished_at: 'Finished',
    meetings_no_participants: 'No participants registered.',
    meetings_planned_title: 'Room not started yet',
    meetings_planned_desc: 'Start this meeting to create/open the video room and move it to in-progress.',
    meetings_external_title: 'Meeting opened in a new tab',
    meetings_external_desc: 'Neo keeps the meeting controls here, but the video room runs outside the WebUI to avoid browser iframe blocking.',
    meetings_popup_blocked: 'Popup blocked. Use “Open in new tab”.',
    meetings_post_desc: 'Generate a structured summary in chat and use it to capture decisions, pending items and Jira candidates.',
...
LOCALES['pt-BR'] = {
  ...
  meetings_detail_hint: 'Clique em qualquer reunião da lista para ver os detalhes aqui.',
  meetings_created_at: 'Criada',
  meetings_started_at: 'Iniciada',
  meetings_finished_at: 'Finalizada',
  meetings_no_participants: 'Nenhum participante cadastrado.',
  meetings_planned_title: 'Sala ainda não iniciada',
  meetings_planned_desc: 'Inicie esta reunião para criar/abrir a sala de vídeo e mover para em andamento.',
  meetings_external_title: 'Reunião aberta em nova aba',
  meetings_external_desc: 'Neo mantém os controles da reunião aqui, mas a sala de vídeo roda fora da WebUI para evitar bloqueio de iframe pelo navegador.',
  meetings_popup_blocked: 'Pop-up bloqueado. Use “Abrir em nova aba”.',
  meetings_post_desc: 'Gere um resumo estruturado no chat para capturar decisões, pendências e candidatas a tarefas no Jira.',
